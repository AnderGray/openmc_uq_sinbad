...
if plotData:
    ...
    plt.errorbar(high['energy'] * 10e5, high['current'], yerr= high['error'] * high['current'] / 100, ecolor= 'blue', fmt='o', capsize=1, markersize = 2, alpha = 1, label='Oktav-Ni High eV')
    plt.errorbar(low['energy'] * 10e5, low['current'], yerr= low['error'] *  low['current'] / 100, ecolor= 'blue', fmt='o', capsize=1, markersize = 2, alpha = 1, label='Oktav-Ni Low eV')
