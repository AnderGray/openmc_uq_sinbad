...
#SBATCH -A dp163
#SBATCH -p cosma7
#SBATCH -J Kant_tendl_processing
#SBATCH -e Kant_tendl_errors
#SBATCH -o Kant_tendl_print
#SBATCH -D ./
#SBATCH --export=ALL
#SBATCH -N 1
#SBATCH -n 28
...
EXEC="sample_sandy.py -s 500 -n Pb206 Pb207 Pb208 -p $SLURM_NTASKS -d tendl_rand -l $TENDL_ENDF"
